                    ...
                    <table className="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td>Tổng tiền:</td>
                                <td>
                                    <span>{/* Replace th:text with curly braces for dynamic values */}300000VND</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Thời gian thanh toán:</td>
                                <td>
                                    <span>{/* Replace th:text with curly braces for dynamic values */}1/1</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Mã giao dịch:</td>
                                <td>
                                    <span>
                                        {/* Replace th:text with curly braces for dynamic values */}
                                        {transactionId}
                                    </span>
                                </td>
                            </tr>
