...
export default function OrderUser() {
    ...
    const handleShowProductByID = (productId) => {
        if (toggleDetail) {
            // Chỉ chuyển hướng khi toggleDetail là true và click vào title
                                ...
                                {orderDetail.length > 0 &&
                                    orderDetail.map((order, index) => (
                                        <TableRow key={index} className="custom-cell">
                                            ...
                                            <TableCell align="left" className="custom-cell-order-user">
                                                <div className="custom-cell-order-title">
                                                    <button onClick={handleShowProductByID(order.product.id)}>
                                                        {order.product.title}
                                                    </button>
                                                </div>
                                            </TableCell>
