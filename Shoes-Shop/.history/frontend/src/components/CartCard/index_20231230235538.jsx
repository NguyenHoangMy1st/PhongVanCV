...
export default function CartCard({ product, onIncreaseQuantity, onDeCreaseQuantity, onDelete, sizes }) {
                ...
                <div className="cartList-detail ">
                    ...
                    <div className="cartList-content">
                        ...
                        <div className="cartList-content-color">
                            ...
                            <button className="cartList-content-color-p color-main-text">Size: {product?.size}</button>
                        </div>
                    </div>
                </div>
