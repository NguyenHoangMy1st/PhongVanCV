                        ...
                        <div className="cartList-content-color">
                            ...
                            <div>
                                <button onClick={handleShowSize}>
                                    <span className="cartList-content-color-p color-main-text" value={selectedSize}>
                                        Size: {product?.size}
                                    </span>
                                    ...
                                    <div className="size-form">
                                        ...
                                        <ul>
                                            {product?.product?.sizes.map((size) => (
                                                <li key={size.name}>
                                                    <button onClick={() => handleSelectSize(size)}>{size?.name}</button>
                                                </li>
                                            ))}
                                        </ul>
                                        <button onClick={handleHideSize}>Close</button>
                                    </div>
                                )}
                            </div>
                        </div>
