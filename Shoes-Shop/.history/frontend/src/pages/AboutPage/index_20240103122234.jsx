                            ...
                            <div className="about-table">
                                ...
                                <div className="about-table-size">
                                    ...
                                    <div className="about-size-buttons">
                                        {productDetail.sizes.map((size) => (
                                            <Button
                                                primary
                                                disabled={selectedSizeQuantity <= 0 ? false : true}
                                                key={size.name}
                                ...
                                <div className="about-quantity">
                                    <div className="about-quantity-detail">
                                        <Button primary text="-" onClick={handleDecreaseQuantity}>
                                            -
                                        </Button>
                                        <input
                                            type="text"
                                    ...
                                    <div className="about-payment">
                                        <Button 
                                                primary text="Add To Cart" onClick={() => handleAddToCart(productDetail.id)}>
                                            Add To Cart
                                        </Button>
